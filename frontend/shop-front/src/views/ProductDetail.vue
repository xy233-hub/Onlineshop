...
const purchasePromotionInfo = computed(() => {
  ...
  return {
    ...
    current_price: p.price ?? promo.current_price ?? p.current_promotion_price ?? null,
    current_promotion_price: p.price ?? promo.current_promotion_price ?? p.current_promotion_price ?? null,
