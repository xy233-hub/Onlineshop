              ...
              <div class="product-content">
                <div class="product-image">
                  <el-image
                      ...
                      class="thumb"
                      lazy
                      placeholder="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' fill='%23f0f0f0'%3E%3Crect width='100' height='100' fill='%23f0f0f0'/%3E%3Ctext x='50' y='50' font-size='14' text-anchor='middle' dy='.3em' fill='%23999'%3E加载中...%3C/text%3E%3C/svg%3E"
                  />
                </div>
...
@media (max-width: 700px) {
  ...
  .main-content { padding: 12px; margin: 12px auto; }
  .search-bar { flex-direction: column; align-items: stretch; }
  .search-input { max-width: none; width: 100%; }
  .category-button { width: 100%; justify-content: center; }
  .category-button .cat-label { max-width: none; }
}
...
@media (max-width: 420px) {
  ...
  .header-actions { flex-direction: column; gap: 8px; padding: 8px 0; }
  .main-content { padding: 8px; margin: 8px auto; }
